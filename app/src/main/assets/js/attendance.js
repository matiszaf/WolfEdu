function attendance(){
  ...
  let classes=wolfSchool.classes||[],students=wolfSchool.students||[],subjects=wolfSchool.subjects||[],teachers=wolfSchool.teachers||[],list=wolfSchool.attendance||[],can=canManageSchool();
  app.innerHTML=`${can?`<div class="card"><h2>Dodaj wpis</h2>
  ...
  <button style="width:100%" onclick="addCloudAttendance(this)">Dodaj wpis</button></div>`:`<div class="card"><small>Edycja frekwencji wymaga roli administratora, dyrektora lub właściciela.</small></div>`}
